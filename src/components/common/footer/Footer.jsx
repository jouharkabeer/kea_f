...
import  Alethea  from "../../../assets/alethea.png"
import lsofito from "../../../assets/Logo Branding LSofito-7.png"
import lsofitoWhite from "../../../assets/Logo main white-01.png"
import lsofitosvg from "../../../assets/main blue-01.svg"
import lsofitoBlack from "../../../assets/lsofito.png"
const Footer = () => {
  return (
          ...
          <div className="footer-grid">
            ...
            <div className="footer-col">
              ...
              <ul className="footer-links">
                ...
                <li><a href="/events"><FaChevronRight className="link-icon" /> Events</a></li>
            ...
            <div className="footer-col">
              ...
              <br/> */}
              <h3>Branding Partner</h3>
              <ul className="footer-links">
                <li className="footer-logo-branding"><a href="https://aletheatech.com/"><img src={Alethea}/></a></li>
              </ul>
              <br/>
              {/* <h3>Software Partner</h3>
              <ul className="footer-links">
                <li className="footer-logo"><a href="https://lsofito.com/"><img src={lsofitoBlack}/></a></li>
              </ul> */}
            </div>
          </div>
        </div>
