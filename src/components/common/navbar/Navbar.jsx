...
const { error: showError, info } = useNotification();
  ...
  const RegAlert = () => {
    // alert("Registration is currently closed. Please contact the KEA office for membership.");
    info("Registration is not Started. Please contact the KEA office for membership.");
  }
    ...
    <>
      ...
      <div className={`header-top ${hideTop ? 'hidden' : ''}`}>
        <div className="header-top__left">
          ...
          <span className="header-contact">
            <FaPhoneAlt size={12} />
            <span>+91 95907 19394,</span>
            <span>+91 96202 23980</span>
          </span>
        </div>
        ...
        <div className="header-top__right">
          ...
          <div className="header-social">
            ...
            <a href="https://wa.me/919590719394" aria-label="WhatsApp"><FaWhatsapp size={12} /></a>
          </div>
        </div>
      </div>
