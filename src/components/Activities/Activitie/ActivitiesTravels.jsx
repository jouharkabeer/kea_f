...
import travel9 from "../../../assets/travel/10009.jpeg";
  ...
  return (
    <div className="kea-activities">
      ...
      <section className="kea-activities__hero">
        <img src={travel9} alt="KEA Activities & Travels" className="kea-activities__hero-image" />
        <div className="kea-activities__hero-overlay">
          ...
          <a className="kea-activities__cta-btn">Join Us</a>
